/**
 * DATA VIEW - MASTER ENGINE v27.0
 * Fixed: Drag & Drop Logic fully synchronized with Click events.
 */
...
function startDragNew(e, w, h) {
    ...
    draggingElement.innerHTML = `<div class="box-content" style="color:white">Place in Grid</div>`;
...
function renderEditCanvas() {
    ...
    // Explicitly re-attach window-level drag listeners
...
async function exportData() {
    ...
    zip.file(`${fileNameBase}_updated.xlsx`, XLSX.write(wb, { bookType: 'xlsx', type: 'array' }));
    ...
    const link = document.createElement('a'); link.href = URL.createObjectURL(content); link.download = `${fileNameBase}_Package.zip`; link.click();
}
