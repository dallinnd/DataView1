/**
 * DATA VIEW - MASTER ENGINE v19.0
 * Unified Drag System, ZIP Packager, Live Entry, and History Log.
 */
...
function drawBoxes() {
    ...
    currentView.boxes.forEach((box, i) => {
        ...
        div.onmousedown = (e) => startDragExisting(e, i); div.onclick = (e) => { e.stopPropagation(); if (!draggingElement) openChoiceMenu(i); };
...
function startPresentation() {
    ...
    window.addEventListener('keydown', (e) => { if (e.key === 'ArrowRight' || e.key === ' ') nextSlide(); if (e.key === 'ArrowLeft') prevSlide(); if (e.key === 'Escape') window.close(); });
}
